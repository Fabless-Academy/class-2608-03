...
```
grep -rn "TEST-BUTTON" TOPST_Education/ch11_Zonal_Application
```
...
- [qml/components/BottomActionDock.qml](ch11_Zonal_Application/TOPST_DashBoard/qml/components/BottomActionDock.qml)
...
- [qml/main.qml](ch11_Zonal_Application/TOPST_DashBoard/qml/main.qml)
...
- [tcpclient.h](ch11_Zonal_Application/TOPST_DashBoard/tcpclient.h) /
  [tcpclient.cpp](ch11_Zonal_Application/TOPST_DashBoard/tcpclient.cpp)
...
- [bev_lane_modules/scenario.py](ch11_Zonal_Application/Bridge_App/bev_lane_modules/scenario.py)
...
- [bev_lane_modules/control.py](ch11_Zonal_Application/Bridge_App/bev_lane_modules/control.py)
...
- [zonal_app.py](ch11_Zonal_Application/Bridge_App/zonal_app.py)
...
- `client connected` 로그가 안 뜨면 → Qt(C++)가 control socket에 접속조차 못 하는 상태.
  (`Connection refused` 등은 브리지 미실행/포트 불일치, [config.json](ch11_Zonal_Application/TOPST_DashBoard/config.json)의
