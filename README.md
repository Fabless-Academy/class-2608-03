...
---
## Telechips Project 발표 일정

### 09:00 ~ 09:30 : 발표 준비
- 발표자료는 13:00 까지 `G-Drive:자료/Telechips/프로젝트 보고서`에 올리기
- 발료자료는 `.ppt`/`pdf`를 같이 올립니다. 
- 이름 규칙
  - `00_텔레칩스_프로젝트_발표자료_3기_홍길동.pptx`
  - `00_텔레칩스_프로젝트_발표자료_3기_홍길동.pdf`
  - 번호는 공유 googlesheet의 번호를 참고
### 09:30 ~ 11:30 : 발표 진행
  - 1인당 10분 ( Q&A 포함 )
  - 쉬는 시간 없이 진행
### 발표 종료 ~ 13:00 : 점심
### 13:00 ~ 13:50 : Telechips 환경 정리
### 14:00 ~ 17:50 : Linux System Programming 강의

---
## Telechips 환경 setup

1. [Host Windows PC setup](./docs/Telechips/docs/setup_env.md)
2. [D3-G](./docs/Telechips/docs/d3_g/setup.md)
3. [VCP-G](./docs/Telechips/docs/vcp_g/readme.md)
4. [AI-G](./docs/Telechips/docs/ai_g/readme.md)
5. [QT-Design](./docs/Telechips/docs/qt-design/readme.md)
